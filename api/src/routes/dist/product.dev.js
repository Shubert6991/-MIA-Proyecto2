  ...
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 55:
          //insertar producto
          sql = "INSERT INTO producto(nombre,descripcion,precio,cantidad,usuario_idUsuario,usuario_correo,usuario_pais_idPais,categoria_idCategoria,foto) " + "VALUES ('".concat(nombre, "','").concat(descripcion, "',").concat(precio, ",").concat(cantidad, ",").concat(idUsuario, ",'").concat(correo, "',").concat(idPais, ",").concat(idCategoria, ",'noPic')");
          _context.next = 58;
          return regeneratorRuntime.awrap(db.Open(sql, [], true));

        case 58:
          insert = _context.sent;
          console.log(insert); //obtener id de ultimo producto
